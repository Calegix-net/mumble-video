...
XboxInput::XboxInput()
	...
	m_getStateFunc = reinterpret_cast< XboxInputGetStateFunc >(reinterpret_cast< void * >(GetProcAddress(m_xinputlib, "XInputGetState")));
	...
	m_getStateExFunc = reinterpret_cast< XboxInputGetStateFunc >(reinterpret_cast< void * >(GetProcAddress(m_xinputlib, (char *) 100)));
